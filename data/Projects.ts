...
export const projectsData = [
  ...
  },
  {
    ...
    title: {
      en: 'Industrial Data Dashboard',
      tr: 'Endüstriyel Veri Paneli',
    },
    description: {
    ...
    features: {
      en: [
        'Interactive visualization of key operational metrics.',
        'Dynamic filtering and drill-down capabilities for data exploration.',
        'Structured data processing and automated dataset integration.',
      ],
      tr: [
        'Temel operasyonel metriklerin interaktif görselleştirmesi.',
        'Veri keşfi için dinamik filtreleme ve detaylandırma (drill-down) yetenekleri.',
        'Yapılandırılmış veri işleme ve otomatik veri seti entegrasyonu.',
      ],
    },
    challenges: {
      en: [
        'Efficiently processing and visualizing structured datasets in a web-based environment.',
        'Maintaining data consistency across different datasets and reporting periods.',
        'Designing an intuitive interface for users with different levels of technical expertise.',
      ],
      tr: [
        'Web tabanlı bir ortamda yapılandırılmış veri setlerini verimli bir şekilde işlemek ve görselleştirmek.',
        'Farklı veri setleri ve raporlama dönemleri arasında veri tutarlılığını korumak.',
        'Farklı teknik uzmanlık seviyelerine sahip kullanıcılar için sezgisel bir arayüz tasarlamak.',
      ],
    },
    accomplishments: {
      en: [
        'Created an interactive environment for exploring operational data.',
        'Streamlined data preparation and visualization workflows.',
        'Demonstrated how structured data can be transformed into actionable insights.',
      ],
      tr: [
        'Operasyonel verileri keşfetmek için interaktif bir ortam oluşturdum.',
        'Veri hazırlama ve görselleştirme iş akışlarını optimize ettim.',
        'Yapılandırılmış verilerin nasıl eyleme dönüştürülebilir içgörülere dönüştürülebileceğini gösterdim.',
      ],
    },
  },
  {
